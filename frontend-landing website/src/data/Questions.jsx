...
export const Buying = [
  {
    title: "How can I opt for the service?",
    content: [
      {
        type: "paragraph",
        text: `You can register your interest by calling us at 1800 8899 555, filling a form on <a href="https://jio.com/business" target="_blank" rel="noopener noreferrer">jio.com/business</a>, or writing to us at <a href="mailto:business@jio.com">business@jio.com</a>, our representative will get in touch with you to service your requirements.`
      }
    ]
  }
];
export const OnboardingAndActivation = [
  ...
  {
    title: "What documents can I submit as proof of the address of the organization?",
    content: [
      {
        type: "paragraph",
        text: `Please <a href="https://jep-asset.akamaized.net/enterprisestaticresources/prod/v01/en-pdf/POA_Org.pdf" target="_blank" rel="noopener noreferrer">click</a> to view the documents that can be accepted as proof of address for the organization.`
      }
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "paragraph",
        text: `Please <a href="https://jep-asset.akamaized.net/enterprisestaticresources/prod/v01/en-pdf/POA_Org.pdf" target="_blank" rel="noopener noreferrer">click</a> to view the documents that can be accepted as proof of personal identity for authorized signatory for the organization.`
      }
    ]
  },
  {
    title: "What documents are accepted as proof of authorization for authorized signatory of the organization?",
    content: [
  ...
  {
    title: "What is difference between billing address and installation address?",
    content: [
      {
        type: "paragraph",
        text: `Billing address is the one on which you would receive the physical bills and installation address is the location where service is being offered or initiated.`
      }
    ]
  }
...
export const CustomerService = [
  {
    ...
    content: [
      {
        type: "paragraph",
        text: `Please login to Self-Care portal for self-troubleshooting procedure associated with your query. In case your issue is not resolved, you may call at 1800 891 8911 or write an email at <a href="mailto:enterpriseIoTcare@jio.com">enterpriseIoTcare@jio.com</a>`
      }
    ]
  },
  {
    title: "What features can I view in Self-Care portal?",
    content: [
      {
        type: "paragraph",
        text: `All reports, billing details, service status, intelligent routing can be configured or viewed via the Self-Care portal.`
      }
    ]
  },
  {
    title: "Where can I raise a request for additional services or for change of plan?",
    content: [
      {
        type: "paragraph",
        text: `Login to your Self-Care portal to add value-added services or change requests, view and create a service ticket for the desired query or seek pre-sales support.`
      }
    ]
  },
  {
    title: "I am unable to open or properly view JioBusiness website?",
    content: [
      {
        type: "paragraph",
        text: `Kindly clear your browser history and try again. For better user experience please, check if you are using these browser versions i.e. Chrome 1.0 or higher and Internet explorer 7 or higher.`
      }
    ]
  }
];
export const BillsAndPay = [
  {
    ...
    content: [
      {
        type: "paragraph",
        text: `Billing frequency is on a monthly basis for the available plans and that of VAS Charges.`
      }
    ]
  },
];
